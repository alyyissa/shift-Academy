...
const Section1 = () => {
  return (
      <section className="px-3 sm:px-4 md:px-11 lg:px-13 xl:px-14 2xl:px-16 py-24 bg-white">
        <Title 
        smallTitle="Features"
        ...
        <div className="flex justify-center items-center gap-x-5 gap-y-12 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            <div
              ...
              <svg className="stroke-indigo-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 24 24" fill="none">
                <path d="M4 7h16M4 12h10M4 17h6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            <div
              ...
              <svg class="stroke-red-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 5.5v19c0 .83.9 1.35 1.63.9L23 17.5c.7-.43.7-1.5 0-1.93L7.63 4.6C6.9 4.15 6 4.68 6 5.5z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <h4 className="text-lg font-medium text-gray-900 mb-3 capitalize">
              Video Explanations
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            <div
              ...
              <svg className="stroke-teal-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 24 24" fill="none">
                <path d="M12 8v4l3 3M5.5 4h13a1.5 1.5 0 0 1 1.5 1.5v13a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 18.5v-13A1.5 1.5 0 0 1 5.5 4Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <h4 className="text-lg font-medium text-gray-900 mb-3 capitalize">
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            <div
              ...
              <svg className="stroke-orange-600 transition-all duration-500 group-hover:stroke-white" width="30" height="30" viewBox="0 0 24 24" fill="none">
                <path d="M12 2 2 7l10 5 10-5-10-5Zm0 15v5m-6-3h12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            <h4 className="text-lg font-medium text-gray-900 mb-3 capitalize">
