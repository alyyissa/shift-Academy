...
const Section1 = () => {
  return (
      <section class="px-3 sm:px-4 md:px-11 lg:px-13 xl:px-14 2xl:px-16 py-24 bg-white">
        <div class="">
            ...
            <div
                class="flex justify-center items-center gap-x-5 gap-y-12 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
