      ...
      <div class="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
        <div class="flex items-center gap-2">
          ...
          <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div class="h-1.5 rounded-full bg-yellow-300 w-[20%]"></div>
          </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div class="h-1.5 rounded-full bg-yellow-300 w-[60%]"></div>
          </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div class="h-1.5 rounded-full bg-yellow-300 w-[15%]"></div>
          </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div class="h-1.5 rounded-full bg-yellow-300 w-5%]"></div>
          </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
            <div class="h-1.5 rounded-full bg-yellow-300 w-0"></div>
          </div>
