...
const Cart = () => {
  return (
    <section className="bg-cover bg-no-repeat bg-center py-10 flex justify-center items-center px-3 sm:px-4 md:px-11 lg:px-13 xl:px-14 2xl:px-16"
    style={{backgroundImage: `url(${assets.background})`}}>
      <div className="w-full">
        <h2 className="text-xl font-semibold text-gray-900 sm:text-2xl">Shopping Cart</h2>
        <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-10">
          <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
            <div className="space-y-6 mb-5">
              <div className="rounded-lg border  bg-gray-900 p-4 shadow-sm  md:p-6">
                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                  ...
                  <div className="flex items-center justify-between md:order-3 md:justify-end">
                    ...
                    <div className="text-end md:order-4 md:w-32">
                      <p className="text-base font-bold text-coprimary">$1,499</p>
                    </div>
                  </div>

                  <div className="w-full min-w-0 flex-1 md:order-2 md:max-w-md">
                    <a href="#" className="text-lg font-bold text-coprimary hover:underline">Computer Organization</a>
                    <p className='text-coprimary text-sm'>
                      asdasdlhads
                    </p>
                    <div className="flex items-center gap-4 mt-2">
                      <button type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500 cursor-pointer">
          ...
          <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
            <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-10">
